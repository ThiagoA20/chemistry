class element:
    def __init__(self, name, numero_atomico, mass, **kwargs):
        self.name = name,
        self.num = numero_atomico,
        self.mass = mass
        self.abreviacao = kwargs.get('abreviacao')


atomos = {
    "H": element("Hidrogênio", 1, 1, abreviacao="hidr"),
    ...
    "S": element("Enxofre", 16, 32, abreviacao="sulf"),
